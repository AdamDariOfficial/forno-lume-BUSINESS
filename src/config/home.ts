// Editorial content shown on the homepage. Kept separate from site.ts so
...
export const homeContent = {
  ...
  faq: [
    ...
    {
      q: "Sono disponibili proposte vegetariane?",
      a: "Sì, il menu include diverse proposte vegetariane e stagionali. La disponibilità può variare con il mercato.",
    },
    {
      q: "È possibile ordinare da asporto?",
      a: "Alcune proposte, in particolare i lievitati, sono disponibili anche da asporto. Scrivici per sapere cosa è disponibile oggi.",
    },
    {
    ...
    },
    {
      ...
      a: "Segnalale al momento della prenotazione o direttamente al personale in sala: cercheremo insieme la proposta più adatta.",
    },
  ],
};
